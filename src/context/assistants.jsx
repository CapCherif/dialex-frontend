...
const assistants_prompt = {
    "conversation":` Bonjour,
     je suis un assistant juridique virtuel conversationnel.
    ...
    ,
    "complétion":`Bonjour,
     je suis un assistant juridique virtuel, spécialisé en droit algérien.
    ...
    `,
    "résumé":`Bonjour,
     je suis un expert juridique virtuel, spécialisé en droit algérien.
    ...
    `,
    "explication":`Bonjour,
     je suis un expert juridique spécialisé en droit algérien.
    ...
    `,
    "rédaction":`Bonjour, 
    je suis un assistant juridique virtuel spécialisé en droit algérien. Mon rôle est d'aider l'utilisateur 
